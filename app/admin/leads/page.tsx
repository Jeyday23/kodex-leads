...
export const metadata: Metadata = {
  title: "SEO Lead Inbox",
  description: "Captured and scored leads generated by SEO assessment flows.",
  ...
  return (
    <main className="main">
      <section className="hero">
        ...
        <h1>SEO Lead Inbox</h1>
        <p className="summary">
          Review captured leads, qualification scores, attribution and routing status from SEO assessment journeys.
        </p>
      </section>
      ...
      <section className="discovery-results" aria-label="Discovered lead candidates">
        <div className="result-heading">
          ...
          <a className="secondary-link" href="/">Run discovery</a>
        </div>
      ...
      <section className="queue-table" aria-label="Lead inbox">
        ...
        {leads.length === 0 ? (
          <p className="empty-state">No SEO leads captured yet.</p>
        ) : (
          leads.map((lead) => (
