...
const nav = [
  ...
  ["Growth", "/admin/authority/growth", "✦"],
  ["Brain", "/admin/authority/brain", "◇"],
  ["Site Audit", "/admin/authority/site-audit", "⌘"],
  ["Signals", "/admin/authority/signals", "⋈"],
  ["Growth Leads", "/admin/authority/growth-leads", "◎"],
  ["Sequences", "/admin/authority/sequences", "✉"],
  ["Planner", "/admin/authority/planner", "▥"],
  ["Channels", "/admin/authority/channels", "▧"],
  ["CMO", "/admin/authority/cmo", "◌"],
